package ru.verkhoumov.asynctask;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Создаём ссылку на элемент прогресс бара.
    ...
    public void doReset(View view) {
        ...
        // Деактивируем кнопку сброса.
        disabledResetButton();
    }

    public void enabledResetButton() {
    ...
    public void disabledResetButton() {
        Button button = (Button) findViewById(R.id.resetBtn);
    ...
    private class BlurImageTask extends AsyncTask<Bitmap, Integer, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            // По окочанию выполнения операции надо обнулить прогресс бар.
